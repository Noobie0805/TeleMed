  ...
  return (
    <nav className="navbar">
      ...
      <ul className="navbar-links">
        ...
        <li><NavLink to="/assistant" className={({ isActive }) => isActive ? 'active' : ''}>Assistant</NavLink></li>
        <li><NavLink to="/consult" className={({ isActive }) => isActive ? 'active' : ''}>Appointments</NavLink></li>
